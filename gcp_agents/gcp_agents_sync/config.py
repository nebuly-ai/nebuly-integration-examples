...
class Config:
    ...
    @property
    def reasoning_engine_key(self) -> str:
        return (
            f"{self.gcp_project_id}/{self.gcp_location}/{self.gcp_reasoning_engine_id}"
        )
    ...
    def from_env_and_args(cls, argv: list[str] | None = None) -> Config:
        ...
        parser = argparse.ArgumentParser(
            description="Sync GCP Reasoning Engine sessions to Nebuly"
        )
        parser.add_argument(
        ...
        gcp_reasoning_engine_id = os.environ.get("GCP_REASONING_ENGINE_ID")
        ...
        return cls(
            ...
            gcp_reasoning_engine_id=cast(str, gcp_reasoning_engine_id),
            gcp_max_requests_per_minute=int(
